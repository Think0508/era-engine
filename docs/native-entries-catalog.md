...
| 连绵 | 攻击后 | instant@action_end · chance=0.3 | combat-wuxia/battle-effects.toml |
| 毒 | 命中后·挂状态 | zone→enemy · settle=turn_start · apply=apply_poison · pct=0.01 · growth=0.25 | combat-wuxia/battle-effects.toml |
| 封穴 | 命中后·挂状态 | zone→enemy · settle=action_pre · chance=0.3 | combat-wuxia/battle-effects.toml |
| 寒毒 | 命中后·挂状态 | zone→enemy · settle=turn_start · apply=apply_element · pct=0.05 · growth=0.5 | combat-wuxia/battle-effects.toml |
| 缓慢 | 命中后·挂状态 | zone→enemy · flat=-10 · chance=0.3 | combat-wuxia/battle-effects.toml |
| 火毒 | 命中后·挂状态 | zone→enemy · settle=turn_start · apply=apply_element · pct=0.05 · growth=0.5 | combat-wuxia/battle-effects.toml |
| 减闪避 | 命中后·挂状态 | zone→enemy · flat=-10 | combat-wuxia/battle-effects.toml |
| 截脉 | 命中后·挂状态 | zone→enemy · pct=-0.3 · chance=0.3 | combat-wuxia/battle-effects.toml |
| 流血 | 命中后·挂状态 | zone→enemy · settle=turn_start · pct=0.05 · chance=0.3 | combat-wuxia/battle-effects.toml |
| 破甲 | 命中后·挂状态 | zone→enemy · pct=-0.5 | combat-wuxia/battle-effects.toml |
| 破绽 | 命中后·挂状态 | zone→enemy · pct=-0.5 · growth=0.5 | combat-wuxia/battle-effects.toml |
| 失势 | 命中后·挂状态 | zone→enemy · pct=-0.5 · chance=0.3 | combat-wuxia/battle-effects.toml |
| 战中毒 | 命中后·挂状态 | zone→enemy · settle=turn_start · flat=15 · growth=1 | combat-wuxia/battle-effects.toml |
| 致盲 | 命中后·挂状态 | zone→enemy · pct=-0.3 · chance=0.3 | combat-wuxia/battle-effects.toml |
| 乘势 | 命中后·即时 | instant@damage_base · pct=0.3 | combat-wuxia/battle-effects.toml |
| 吸内 | 命中后·即时 | instant@on_hit · flat=20 | combat-wuxia/battle-effects.toml |
| 消内 | 命中后·即时 | instant@on_hit · flat=20 | combat-wuxia/battle-effects.toml |
| 饮血 | 命中后·即时 | instant@attack_end · pct=0.2 | combat-wuxia/battle-effects.toml |
| 增加暴击伤害 | 命中后·即时 | instant@damage_crit · pct=0.5 | combat-wuxia/battle-effects.toml |
| 增伤 | 命中后·即时 | instant@on_hit · pct=0.2 · chance=0.3 | combat-wuxia/battle-effects.toml |
