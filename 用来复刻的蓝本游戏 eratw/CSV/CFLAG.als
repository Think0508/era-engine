...
30,神社在住
;CFLAG:神社在住は「MAIN_MAPの住人である場合に自室の場所ID（拠点マップ版）を記録」している（MAIN_MAPに住んでいない場合は0）
31,引き継ぎ
...
36,口上実装状況
;37,固有料理
;LEARNED_MENUへ移行,固有料理の経験値,100以上でラーニング済み,一度覚えると100+DAYに変化
...
;CFLAG:200～239はノーマル服装パターン記憶用
;CFLAG:240～260はパジャマパターン記憶用
...
310,地位
311,初始位置
;CFLAG:初期位置は一日を開始した時点での各キャラの開始位置、拠点マップ上の位置を記録してある
;MAIN_MAPの住人でない場合にはSUKIMA()送りになっている（＝99）
;これを使うだけでは自室の位置はわからない（MAIN_MAPに住んでいないキャラの情報がわからない）
;MAIN_MAPの住人だとCFLAG:神社在住と同じ、CHARAxx.CSVを参照すると拠点での自室位置がわかる
;312,起床時間
;時刻系はCFLAG:350～を見よ
313,睡眠
;314,起床時間
...
350,職種
;40,清掃 41,会話 42,戦闘 43,教養 44,料理 45,音楽 46,遊び 47,商売中 48,宴会の準備 49,宴会に参加 50,片づけ 51,宴会後の酔い 52,お酒 53,家事 54,採集 55,釣り 56,調合
351,身体測定
352,来訪時間
353,帰宅時間
354,就寝時間
...
;CFLAG:700　着替え実行フラグ（MASTERの目の前でのTARGETのお着替え処理）
...
930,弾幕勝負勝利
931,弾幕特能
;(BIT 0=言笑自若1=温柔敦厚2=勇気凛々3=豪放磊落4=怪力乱神5=洽覧深識6=残忍酷薄7=乾坤一擲8=狷介孤高9=幽愁暗恨)
932,ムシバトル直接勝利
933,料理勝負勝利
...
;Custom flag, 100 for translated, 0 for untranslated, -1 for no dialog
