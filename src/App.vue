// 注释：App.vue 根组件
// Phase 5 开发期间：直接显示 MainGame（用 mock 数据）
// Task 5.15 bridge 实现后：main.ts 控制启动流程（ModSelect → TitleScreen → MainGame）
...
onMounted(() => {
  // 注释：填充 mock 数据供组件开发期间使用
  // TODO(task-5.15): bridge 替换为真实 core 数据
