...
| 状态效�?| `docs/status-system.md` | src/plugins/status-system/ |
...
| H �?| `docs/h-core.md` �?h-*.md | src/plugins/h-*/ |
| H �?NPC AI | `docs/h-npc-ai.md` | src/plugins/h-npc-ai/ |
